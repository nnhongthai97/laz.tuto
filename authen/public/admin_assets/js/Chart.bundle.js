	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		buildScales: function() {
			...
			helpers.each(items, function(item) {
				...
				// TODO(SB): I think we should be able to remove this customer case (options.scale)
				// and consider it as a regular scale part of the "scales"" map only! This would
				// make the logic easier and remove some useless? customer code.
				if (item.isDefault) {
					me.scale = scale;
				}
			});
...
module.exports = function(Chart) {
	...
	var defaultConfig = {
		...
		time: {
			parser: false, // false == a pattern string from http://momentjs.com/docs/#/parsing/string-format/ or a customer callback that converts its argument to a moment
