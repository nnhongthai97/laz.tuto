...
; (function ($, window, document, Math, undefined) {
    ...
    var chartinator = function (el, options) {
        ...
        o.optionsInit = {
            ...
            // The tooltip concatenation - Defines a string for concatenating a customer tooltip.
            ...
            // The annotation concatenation - Defines a string for concatenating a customer annotation.
            // Keywords: 'domain', 'data', 'label' - these will be replaced with current values
            // 'domain': the primary axis value, 'data': the data value, 'label': the column title
            ...
            // The chart aspect ratio customer option - width/height
            ...
            calendar: {
                ...
                // The cell scaling factor customer option - Not a Google Chart option
