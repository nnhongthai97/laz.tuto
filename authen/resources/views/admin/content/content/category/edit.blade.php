...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="category" action="{{url('admin/content/product/'.$cat->id)}}" method="post" class="form-horizontal">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><textarea name="intro" id="txtarea1" cols="50" rows="4" class="form-control1">value="{{$cat->intro}}"</textarea></div>
                </div>
                <div class="form-group">
                    <label for="txtarea1" class="col-sm-2 control-label">Mô tả</label>
                    <div class="col-sm-8"><textarea name="desc" id="txtarea1" cols="50" rows="4" class="form-control1">value="{{$cat->desc}}"</textarea></div>
                </div>
