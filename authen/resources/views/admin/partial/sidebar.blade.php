                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{url('/admin/menuitems')}}"><i class="fa fa-angle-right"></i>Menu-iteam</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('/admin/config')}}"><i class="fa fa-angle-right">Global settings</i></a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('/admin/contacts')}}"><i class="fa fa-angle-right">Liên hệ</i></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('/admin/email/inbox')}}"><i class="fa fa-angle-right">Inbox</i></a></li>
                            <li><a href="{{url('/admin/email/draf')}}"><i class="fa fa-angle-right">Draf</i></a></li>
                            <li><a href="{{url('/admin/email/send')}}"><i class="fa fa-angle-right">Send</i></a></li>
