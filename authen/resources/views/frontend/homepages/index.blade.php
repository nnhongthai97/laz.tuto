                    ...
                    <div class="resp-tabs-container">
                        <div class="tab-1 resp-tab-content">
                            ...
                            <div class="col-md-3 top-product-grids tp2">
                                <a href="single.html"><div class="product-img">
                                        <img src="{{ secure_url('frontend_assets/images/tp2.jpg') }}" alt="" />
                                        <div class="p-mask">
                                            <form action="#" method="post">
                                                <input type="hidden" name="cmd" value="_cart" />
                                                <input type="hidden" name="add" value="1" />
    ...
    <div class="top-brands">
        <div class="container">
            ...
            <div class="sliderfig">
                <ul id="flexiselDemo1">
                    <li>
                        <img src="{{ secure_url('frontend_assets/images/4.png') }}" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{ secure_url('frontend_assets/images/5.png') }}" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{ secure_url('frontend_assets/images/6.png') }}" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{ secure_url('frontend_assets/images/7.png') }}" alt=" " class="img-responsive" />
                    </li>
                    <li>
                        <img src="{{ secure_url('frontend_assets/images/46.jpg') }}" alt=" " class="img-responsive" />
                    </li>
                </ul>
            </div>
            ...
            <script type="text/javascript" src="{{ secure_url('frontend_assets/js/jquery.flexisel.js') }}"></script>
        </div>
    </div>
    <!-- //top-brands -->
@endsection
